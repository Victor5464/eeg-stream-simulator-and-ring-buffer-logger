...
class SignalGenerator:
    ...
    def __init__(
        ...
        self._seed = seed  # Store the seed to reset the generator state later
    ...
    def reset(self) -> None:
        """Resets the internal clock and restores the RNG to its initial state."""
        self.current_time = 0
        self._rng = np.random.default_rng(self._seed)  # Resets the noise sequence!
